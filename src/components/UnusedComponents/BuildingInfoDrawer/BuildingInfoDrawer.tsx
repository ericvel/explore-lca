...
import { createStyles, useTheme, Theme, withStyles, WithStyles, makeStyles } from '@material-ui/core/styles';
        ...
        <div>
            ...
            >
                <div>
                    ...
                    <BuildingElementsView buildingId={props.selectedBuildingId} parentIsLoading={loading} />
                </div>
            </Drawer>
        </div>
    );

...
const CompareBuildingDialog = () => {
  ...
  const isCompareDialogOpen = useSelector(
    (state: IRootState) => state.isCompareDialogOpen
  );
  ...
  buildings.forEach((building) => {
    if (a1a3)
      gwpChartData[
        gwpChartData.findIndex((arrayEntry) => arrayEntry.lcaPhase === "A1-A3")
      ][building.idbuildings] = Number(building.A1A3) || 0.0;
    if (a4)
      gwpChartData[
        gwpChartData.findIndex((arrayEntry) => arrayEntry.lcaPhase === "A4")
      ][building.idbuildings] = Number(building.A4) || 0.0;
    if (b4_m)
      gwpChartData[
        gwpChartData.findIndex((arrayEntry) => arrayEntry.lcaPhase === "B4 (m)")
      ][building.idbuildings] = Number(building.B4_m) || 0.0;
    if (b4_t)
      gwpChartData[
        gwpChartData.findIndex((arrayEntry) => arrayEntry.lcaPhase === "B4 (t)")
      ][building.idbuildings] = Number(building.B4_t) || 0.0;
